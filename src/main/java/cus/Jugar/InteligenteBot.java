 ...
 * @author esteban
 */
public class InteligenteBot implements IMachineBot {
    ...
    public boolean Jugar(Juegos j) {
        ...
        try {
            ...
            System.out.println("paso 1: cadenas de 1: " + cadenas.size());
            ...
            System.out.println("paso 3: grado3==2? " + grado3.size());
            ...
            System.out.println("paso 4: grado3 > 2?" + grado3.size());
            // Paso 4: si hay cuadros de 3 tomarlos en la cadena menor...
            if (grado3.size() > 0) {
                lst = cadenas.get(0);
                int tam = cadenas.get(0).size();
            ...
            if (grado0.size() > 0) {
                box = grado0.get(rnd.nextInt(grado0.size()));
